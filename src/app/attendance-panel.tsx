...
import { safeStr, safeDate, safeDateLabel, safeTimeLabel, asArray } from '../lib/render-safe';
...
export default function AttendancePanel() {
  ...
  async function load() {
    ...
    try {
      ...
      setRecords(asArray(result.records));
    } catch (reason) {
