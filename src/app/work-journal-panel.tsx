...
export default function WorkJournalPanel({ user, onNavigate, orgRole }: { user: JournalUser; onNavigate?: (page: string) => void; orgRole?: string | null }) {
  ...
  return <WorkJournalAdvanced user={user} onNavigate={onNavigate} orgRole={orgRole} />;
}